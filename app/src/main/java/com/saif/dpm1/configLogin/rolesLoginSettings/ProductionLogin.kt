...
data class FormStateProduction(
...
@Composable
fun FormScreenProductionRol(){

    // ── State ───────────────────────────────────────────────────────
    val defaultState = FormStateProduction()

    var formState by remember { mutableStateOf(defaultState) }
    var savedState by remember { mutableStateOf<FormStateProduction?>(null) }
